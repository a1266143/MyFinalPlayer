...
public class LocalMusicUtils {
	...
	private static ArrayList<LocalMusic> localMusicList;
	 ...
	 * 获取本地音乐列表
	 */
	public static ArrayList<LocalMusic> getLocalMusicArr(Context context){
	 ...
	 * 获取本地音乐专辑列表
	 */
	public static List<Album> getLocalMusicAlbum(Context context){
	 ...
	 * 通过专辑名称返回歌曲数量
	 */
	public static int getNumFromAlbum(Context context,String albumName){
	 ...
	 * @return
	 */
	public static int getArrSize(Context context){
	 ...
	 * 返回localList表
	 */
	public static ArrayList<LocalMusic> getArr(){
		if(localMusicList!=null)
			return localMusicList;
		return null;
	}
